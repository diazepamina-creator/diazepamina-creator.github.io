...
**MATERIALES DE AULA**
Portada y línea del tiempo de los manipulativos de matemáticas para ESO
...
> Asensio, A. (2026). *Materiales de aula: manipulativos de matemáticas
> para 1.º y 2.º de ESO* [Aplicaciones web]. CC BY-NC-SA 4.0.

## Tipografías

Las páginas cargan **Cinzel**, **Cardo**, **Atkinson Hyperlegible** y **Space
Mono** desde Google Fonts, todas bajo la SIL Open Font License 1.1 y propiedad
de sus respectivos autores. Sin conexión, el navegador usa las del sistema y
